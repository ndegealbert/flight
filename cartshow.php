...
echo $rowcount;
    if($rowcount == 0){
        echo "<div class='alert alert-info'><strong>No ticket.</strong></div>";
    }
    else{
    echo "<div class='alert alert-info'>Ticket for resevation:</div>";
    ...
    echo "<div class='row'>
			  ...
			  <div class='col-sm-4'><p class='lead'>Total: <span id='total'>ksh ".$total."</span></p></div>
